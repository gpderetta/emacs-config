...
(deftheme my-purple-haze
  "my-purple-haze-theme Originally By: Jason Milkins, customized by GPD")
...
;; Rainbow delimiters
(defun my-purple-haze-rainbow-delim-set-face ()
...
(eval-after-load "rainbow-delimiters" '(my-purple-haze-rainbow-delim-set-face))
...
(provide-theme 'my-purple-haze)

;; Local Variables:
;; eval: (when (fboundp 'rainbow-mode) (rainbow-mode +1))
;; End:

;;; my-purple-haze-theme.el ends here
