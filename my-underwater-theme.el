;;; my-underwater-theme.el --- A gentle, deep blue color theme
...
;; This is an Emacs 24 port of my-underwater-mod.vim by Mario Gutierrez
...
;; load-theme' and select "my-underwater".

;;; Code:

(deftheme my-underwater "Port of my-underwater Vim theme")
...
(provide-theme 'my-underwater)
;;; my-underwater-theme.el ends here
