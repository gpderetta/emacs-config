...
(custom-set-variables
 ...
 '(cc-other-file-alist (quote (("\\.cc\\'" (".hh" ".h")) ("\\.hh\\'" (".cc" ".C")) ("\\.c\\'" (".h")) ("\\.h\\'" (".c" ".cc" ".C" ".CC" ".cxx" ".cpp")) ("\\.C\\'" (".H" ".hh" ".h")) ("\\.H\\'" (".C" ".CC")) ("\\.CC\\'" (".HH" ".H" ".hh" ".h")) ("\\.HH\\'" (".CC")) ("\\.c\\+\\+\\'" (".h++" ".hh" ".h")) ("\\.h\\+\\+\\'" (".c++")) ("\\.cpp\\'" (".hpp" ".hh" ".h")) ("\\.hpp\\'" (".ipp" ".cpp")) ("\\.cxx\\'" (".hxx" ".hh" ".h")) ("\\.ipp\\'" (".cpp" ".hpp")) ("\\.hxx\\'" (".ixx" ".cxx")) ("\\.ixx\\'" (".cxx" ".hxx")))))
 '(compile-command ". ~/.bashrc && make -k ")
 '(cursor-color "#93a1a1")
 '(custom-enabled-themes (quote (my-underwater)))
...
(global-set-key [f4]  'my-recompile)
(global-set-key [(shift f4)]  'my-compile)
